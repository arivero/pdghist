# Electroweak review — sin²(theta_W), PDG 2025 edition
...
- Source: PDG *Review of Particle Physics* 2025, review "Electroweak Model and
  Constraints on New Physics".
- Downloaded from https://pdg.lbl.gov/2025/reviews/rpp2025-rev-standard-model.pdf
  on 2026-05-15.
...
|---|---|---|
| on-shell (s²_W) | 0.22342 | ±9e-05 |
| effective angle (s²_l) | 0.23154 | ±6e-05 |

Extracted lines from the review text:

```
On-shell              s2W                 0.22342             ±0.00009
Effective angle       s̄2`                0.23154             ±0.00006
```
