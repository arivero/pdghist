# Electroweak review — sin²(theta_W), PDG 2023 edition
...
- Source: PDG *Review of Particle Physics* 2023, review "Electroweak Model and
  Constraints on New Physics".
- Downloaded from https://pdg.lbl.gov/2023/reviews/rpp2023-rev-standard-model.pdf
  on 2026-05-15.
...
|---|---|---|
| on-shell (s²_W) | 0.22339 | ±0.0001 |
| effective angle (s²_l) | 0.23155 | ±4e-05 |

Extracted lines from the review text:

```
On-shell            s2W          0.22339      ±0.00010
Effective angle     s̄2`         0.23155      ±0.00004
```
